  ...
  var Renderer = function(elt){
    ...
    var that = {
      ...
      switchSection:function(newSection){
        ...
        console.log(sys.getEdgesFrom(newSection)[0])
      ...
      _initMouseHandling:function(){
        ...
        var handler = {
          moved:function(e){
            ...
            if ($.inArray(nearest.node.name, ['arbor.js','code','docs','demos']) >=0 ){
  ...
  $(document).ready(function(){
    ...
    var theUI = {
      nodes:{"arbor.js":{color:"red", shape:"dot", alpha:1}, 
             ...
             docs:{color:CLR.branch, shape:"dot", alpha:1, link:'#reference'},
